    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" onclick="closeNoty()">x</button>
            </div>
            <div class="modal-body">
                <form id="detailsForm">
                    <input hidden="id" name="id">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="save()">
